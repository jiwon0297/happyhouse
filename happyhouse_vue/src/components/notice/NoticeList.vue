<template>
  <div>
    <div v-if="articles.length" style="margin-top: 10px">
      <md-table style="text-align: center">
        <md-table-row style="background-color: #dde7e7; text-align: center">
          ...
          <td
            class="md-table-cell"
            style="color: black; text-align: center; width: 40%"
          >
            제목
          </td>
          <td
          ...
          <td
            class="md-table-cell"
            style="color: black; text-align: center; width: 30%"
          >
            작성일
          </td>
        </md-table-row>
    ...
    <div v-else style="margin-top: 10px">
      <md-table style="text-align: center">
        ...
        <md-table-row style="text-align: center">
          <td class="md-table-cell" colspan="4" style="text-align: center">
            작성된 글이 없습니다.
          </td>
        </md-table-row>
      </md-table>
